...
public enum ConsoleColour {
    ...
    public static String wrapString(String s, ConsoleColour consoleColour) {
        return String.format("%s%s%s", consoleColour.getValue(), s, ConsoleColour.RESET.getValue());
    }
}